		...
		<div id="list-item" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="productNumber" title="${message(code: 'item.productNumber.label', default: 'Product Number')}" />
						...
						<g:sortableColumn property="shippingCost" title="${message(code: 'item.shippingCost.label', default: 'Shipping Cost')}" />
				...
				<g:each in="${itemInstanceList}" status="i" var="itemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${itemInstance.id}">${fieldValue(bean: itemInstance, field: "productNumber")}</g:link></td>
						...
						<td>${fieldValue(bean: itemInstance, field: "shippingCost")}</td>
					
						<td>${fieldValue(bean: itemInstance, field: "url")}</td>
