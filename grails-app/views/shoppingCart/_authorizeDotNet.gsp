<form hidden="true" id='myCCForm' name='myCCForm' action='${grailsApplication.config.shoppingService.authorizeDotNet.paymentUrl}'>
<input name='x_card_num'/>
<input name='x_exp_date'/>
<input name='x_amount' value = "${invoice.total}"/>
<input name='x_invoice_num' value='${invoice.id}' /> 
